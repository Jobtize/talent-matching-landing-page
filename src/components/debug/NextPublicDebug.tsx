...
interface ServerData {
  data: {
    nextPublicVars: Record<string, unknown>;
    privateVars: Record<string, unknown>;
    googleMapsAnalysis: Record<string, unknown>;
  };
}
...
export default function NextPublicDebug() {
  ...
  useEffect(() => {
    const analyzeClientSide = () => {
      ...
      const privateVarsTest = {
        'AZURE_SQL_SERVER': (process.env as any).AZURE_SQL_SERVER,
        'AZURE_SQL_PASSWORD': (process.env as any).AZURE_SQL_PASSWORD,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <h3 className="text-lg font-semibold text-green-900 mb-3">📱 Lado Cliente (Browser)</h3>
      ...
      {serverData && (
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <h3 className="text-lg font-semibold text-purple-900 mb-3">🖥️ Lado Servidor (Node.js)</h3>
          <div className="space-y-4">
            <div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">📚 Como Funciona o NEXT_PUBLIC_*</h3>
