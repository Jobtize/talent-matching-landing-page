...
export default function Landing() {
  ...
  // SEO Meta Tags
  useEffect(() => {
    document.title = "Banco de Talentos: Cadastre seu Currículo para Vagas Exclusivas | TalentMatch";
    
    // Update meta description
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Cansado de procurar emprego? Deixe as melhores vagas encontrarem você. Cadastre seu currículo em nosso banco de talentos e receba convites para vagas exclusivas em tecnologia, finanças e mais. Grátis e confidencial.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Cansado de procurar emprego? Deixe as melhores vagas encontrarem você. Cadastre seu currículo em nosso banco de talentos e receba convites para vagas exclusivas em tecnologia, finanças e mais. Grátis e confidencial.';
